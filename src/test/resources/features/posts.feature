Feature: An example
  ...
  Scenario Outline: Validating the scenarios of posts of a user
    ...
    Examples:
      ...
      | Failure Response for not providing token for authentication    | AuthenticationFailed.json | application/json | application/json |                                                                   | 401        | post          | /src/test/resources/RequestBody/CreatePostOption2.json |         |        | option2         |
      ...
      | Success Response to delete a post based on postId              |                           | application/json | application/json | a4d01bb224163ae07a44168015b95a405782feab319515d9745c20415c1623c9  | 204        | delete        |                                                        |         | 17598  | option2         |